package com.voice.configuration;

import com.kikkia.dislog.api.DislogClient;
import com.kikkia.dislog.models.LogLevel;
import com.voice.configuration.properties.DislogConfigProperties;
...
public class DislogConfig {
    ...
    @Bean
    public DislogClient client(DislogConfigProperties properties) {
