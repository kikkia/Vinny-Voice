package com.voice.configuration.auth;

import com.voice.configuration.properties.AuthProperties;
...
@Configuration
public class RequestAuthFilter implements HandlerInterceptor, WebMvcConfigurer {
